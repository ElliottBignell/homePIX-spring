...
public interface KeywordsRepository extends CrudRepository<Keywords, Integer> {
	...
	/**
	 * Retrieve {@link Keywords}s from the data store by content, returning all keywords
	...
	@Query("SELECT DISTINCT keywords FROM Keywords keywords WHERE keywords.content = :content")
	@Transactional(readOnly = true)
	Collection<Keywords> findByContent(@Param("content") String content);
