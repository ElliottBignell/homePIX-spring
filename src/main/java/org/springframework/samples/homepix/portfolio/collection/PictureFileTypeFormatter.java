...
public class PictureFileTypeFormatter implements Formatter<PictureFileType> {
	...
	public PictureFileTypeFormatter(PictureFileRepository pictureFiles, PictureFileRepository pictureFiles1) {
		this.pictureFiles = pictureFiles1;
	}

	@Override
	public String print(PictureFileType pictureFileType, Locale locale) {
		return pictureFileType.getName();
	}

	@Override
	public PictureFileType parse(String text, Locale locale) throws ParseException {
		List<PictureFileType> findPictureFileTypes = this.pictureFiles.findPictureFileTypes();
